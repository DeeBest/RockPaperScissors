...
/* 1.Your game is going to play against the computer, so begin with a function called computerPlay that will 
...
/* 2.Write a function that plays a single round of Rock Paper Scissors. The function should take two parameters - 
     ...
     "You Lose! Paper beats Rock" */
        ...
        /* a.Make your function’s playerSelection parameter case-insensitive (so users can input rock, ROCK, 
            RocK or any other variation). */

        /* b.Important note: you want to return the results of this function call, not console.log() them. 
...
/* 3.Write a NEW function called game(). 
     ...
     keeps score and reports a winner or loser at the end. */
        ...
        /* a.Remember loops? This is a great opportunity to use one to play 
           those five rounds: 
        ...
        /* b.At this point you should be using console.log() to display the results 
             of each round and the winner at the end. */

        /* c.Use prompt() to get input from the user. */

        /* d.Feel free to re-work your previous functions if you need to. Specifically, 
